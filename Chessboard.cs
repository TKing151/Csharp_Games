...
namespace PA6_Draft
{
    public partial class Chessboard : Form
    {
        ...
        internal Chessboard(Color Light, Color Dark, ChessGame Game)
        {
            ...
            label1.Text = Game.BlackTimeLimit.ToString();
            label2.Text = Game.WhiteTimeLimit.ToString();
        ...
        private object Game_Promote(Move move)
        {
            ...
            // create form asking for a piece promotion; take the answer; delete form. use if/else for return statement
            if(x==1)
        ...
        {
            if (listBox1.SelectedItem!= null){if (listBox1.Items[listBox1.SelectedIndex].ToString().Contains("#")) { g = 1; }}
            if (g < 1 && listBox1.SelectedItem != null)
            {
               // if (Game.BlackTimeLimit<10) { }
                if (Game.WhiteTurn)
                {
                    label2.Text = Game.WhiteTimeLimit.ToString();
